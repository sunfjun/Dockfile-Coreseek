...
namespace SphDarts {
  ...
  public:
	...
	void set_result(result_pair_type& x, value_type r, size_t l,array_u_type_ p ) const{
		x.value = r;
		x.length = l;
		x.pos = p;
	}
...
#define SPH_DARTS_ARRAY_SIZE_IS_DEFINED 1
#endif

#if 4 == 4 && !defined(SPH_DARTS_ARRAY_SIZE_IS_DEFINED)
  typedef SphDarts::DoubleArrayImpl<char, unsigned char, int,
                                 unsigned int> DoubleArray;
#define SPH_DARTS_ARRAY_SIZE_IS_DEFINED 1
#endif

#if 4 == 4 && !defined(SPH_DARTS_ARRAY_SIZE_IS_DEFINED)
  typedef SphDarts::DoubleArrayImpl<char, unsigned char, long,
                                 unsigned long> DoubleArray;
#define SPH_DARTS_ARRAY_SIZE_IS_DEFINED 1
#endif

#if 4 == 8 && !defined(SPH_DARTS_ARRAY_SIZE_IS_DEFINED)
  typedef SphDarts::DoubleArrayImpl<char, unsigned char, long long,
                                 unsigned long long> DoubleArray;
#endif
  typedef SphDarts::DoubleArrayImpl<unsigned short, unsigned short, int,
